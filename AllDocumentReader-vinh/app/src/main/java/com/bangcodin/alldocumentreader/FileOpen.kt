/*
 *  Created by Nguyễn Thành Vinh on 09:56, 05/09/2022
 *     ntvtht1204@gmail.com
 *     Last modified 09:56, 05/09/2022
 *     Copyright (c) 2022.
 *     All rights reserved.
 */
...
class FileOpen {
    ...
    companion object{
        ...
        fun openFile(context: Context, url: File) {
            ...
            context.startActivity(Intent.createChooser(intent, "com.bangcodin.alldocumentreader"));
        }
    }
}